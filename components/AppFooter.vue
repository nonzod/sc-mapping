<template>
  ...
  <footer
    ...
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://nicolatomassoni.it/" target="_blank"
        class="hover:underline">Nicola Tomassoni</a>. All Rights Reserved.
    </span>
